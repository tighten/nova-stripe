...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (currency, amount) {
    currency = currency.toUpperCase();

    var symbol = currencies[currency] ? currencies[currency].symbol_native : currency;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ChargesTable_vue__ = __webpack_require__(14);
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("p", { staticClass: "text-sm uppercase mb-2 text-80" }, [
            _vm._v(_vm._s(_vm.__("Available Balance")))
          ]),
          _vm._v(" "),
      ...
      _c(
        ...
        [
          _c("p", { staticClass: "text-sm uppercase mb-2 text-80" }, [
            _vm._v(_vm._s(_vm.__("Pending Balance")))
          ]),
          _vm._v(" "),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ChargesPaginationLinks_vue__ = __webpack_require__(18);
                  ...
                  _vm._l(_vm.charges, function(charge) {
                    return _c("tbody", [
                      _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(_vm.__(charge.status)))]),
                        _vm._v(" "),
                        _c("td", [
                          _c(
                            "span",
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v(_vm._s(_vm.__("Stripe Dashboard")))
      ]),
      _vm._v(" "),
      _c("balance-card"),
      _vm._v(" "),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ChargeDetailCard_vue__ = __webpack_require__(25);
  ...
  return _c(
    ...
    [
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("ID"), value: _vm.charge.id } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("Amount"), value: _vm.amount } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("Fee"), value: _vm.fee } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("Net"), value: _vm.net } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: {
          field: { name: _vm.__("Status"), value: _vm.__(_vm.charge.status) }
        }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("Created"), value: _vm.date } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: {
          field: { name: _vm.__("Metadata"), value: _vm.charge.metadata }
        }
      }),
      _vm._v(" "),
      _c("detail-boolean-field", {
        attrs: {
          field: { name: _vm.__("Livemode"), value: _vm.charge.livemode }
        }
      }),
      _vm._v(" "),
      _c("detail-boolean-field", {
        attrs: {
          field: { name: _vm.__("Captured"), value: _vm.charge.captured }
        }
      }),
      _vm._v(" "),
      _c("detail-boolean-field", {
        attrs: { field: { name: _vm.__("Paid"), value: _vm.charge.paid } }
      }),
      _vm._v(" "),
      _c("detail-boolean-field", {
        attrs: {
          field: { name: _vm.__("Refunded"), value: _vm.charge.refunded }
        }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: { field: { name: _vm.__("Dispute"), value: _vm.charge.dispute } }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: {
          field: {
            name: _vm.__("Fraud Details"),
            value: _vm.charge.fraud_details
          }
        }
      }),
      _vm._v(" "),
      _c("detail-text-field", {
        attrs: {
          field: {
            name: _vm.__("Transfer Group"),
            value: _vm.charge.transfer_group
          }
        }
      })
    ],
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v(_vm._s(_vm.__("Charge Details")))
      ]),
      _vm._v(" "),
